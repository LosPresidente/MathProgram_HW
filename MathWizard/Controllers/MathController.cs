...
//here the actual math gets done --------------------------------------------------------------------
...
/* 
        public IActionResult DoRoundOp(RoundOp roundOp){
            switch(roundOp.RoundOperator){
                case "Round":
                        RoundOp.RoundResult = Math.Round(RoundOp.RoundResult);
                        break;
        }
        return View(roundOp);
    }
